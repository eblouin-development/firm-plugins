...
/**
 * The authenticated landing screen. Port of the Vite SPA's `DashboardPage.tsx`
 * (there the index route under `App`'s layout, `/`; here its own route,
 * `/dashboard`, since `app/page.tsx` is owned by the public SSR landing page —
 * see `app/(app)/layout.tsx`'s nav). Renders the principal resolved from
